   ...
   // double _width = MediaQuery.of(context).size.width;
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: const Text('Now Playing',style: TextStyle(color: Colors.white,fontWeight: FontWeight.w800),),
      ),
      body: SafeArea(
        child: Container(
                      ...
                      children: [
                        ...
                        Visibility(
                          ...
                          child: Row(
                           mainAxisAlignment: MainAxisAlignment.spaceBetween,
                           children: [
                             const Icon(Icons.play_circle_fill,color: themebackground.br,),
                        ...
                        Visibility(
                          ...
                          child: Row(
                            mainAxisAlignment: MainAxisAlignment.spaceBetween,
                            children: [
                              Icon(currentIndex>111 ? null :Icons.play_circle_fill,color: themebackground.br,),
      ...
      children: [
        SliderTheme(
          data: SliderTheme.of(context).copyWith(
            activeTrackColor: themebackground.br,
            inactiveTrackColor: Colors.grey,
            trackHeight: 5.0,
            thumbColor: themebackground.brown,
